      ...
      <main className={styles.main}>
        ...
        <section className={styles.hero}>
          ...
          <p>
            ...
            >
              FREE.
              <PopupInfo isOpen={FOpen}>
                Our service is completely free to use and open source.{" "}
              </PopupInfo>
            </u>
          </p>
        ...
        <div className={styles.problemSolution}>
          <div className={styles.left}>
            ...
            Manual scheduling takes hours <br />
            <br />
            Conflicts between teachers & rooms <br />
            <br />
          ...
          <div className={styles.right}>
            ...
            One-click timetable generation <br />
            <br />
