...
import { 
    ChevronDown, X, Check, ArrowUpRight,
    BrainCircuit, Zap, ListRestart, Sheet, MonitorSmartphone
} from 'lucide-react';
    ...
    return(
        <div className={styles.container}>
            <header className={styles.header}>
                ...
                <nav>
                    <a>Explore <ChevronDown size={16} /></a>
                    <a>Tutorial</a>
                    <a>Help</a>
                </nav>

                <nav className={styles.N2}>
                    <button className={`${styles.secondary} ${styles.action}`}>Log in</button>
                    <button className={`${styles.primary} ${styles.action}`}>Sign up</button>
                </nav>
            </header>
            ...
            <main className={styles.main}>
                ...
                <section className={styles.hero}>
                    <h1>Lorem Ipsum</h1>
                    <p>“Automatically generate optimized timetables based on your needs for <u>FREE.</u>”</p>
                    <button className={`${styles.action} ${styles.primary} ${styles.B1}`}>Get Started<ArrowUpRight /></button>
