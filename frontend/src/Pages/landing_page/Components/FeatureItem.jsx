...
const FeatureItem = ({ message, descr, icon, iconFirst = false }) => {
    ...
    // Icon animation
    const iconScale = useTransform(scrollYProgress, [0, 1], [0.7, 1.1]);
    ...
    return (
        <motion.div
            ref={ref}
            style={{ y, opacity }}
            className={`${styles.container} ${iconFirst ? styles.reverse : ''}`}
        >
